...
import { Sidebar, SidebarNavItem } from "@/website/components/layouts/sidebar";
    ...
    return (
        <div className="bg-background/80 dark:bg-background/90 sticky top-0 z-10 flex h-16 items-center justify-between backdrop-blur-sm">
            <div className="flex items-center gap-2 md:gap-8">
                <Drawer.Root direction="left" open={openDrawer} onOpenChange={setOpenDrawer}>
                    <Drawer.Trigger asChild>
                        <Button variant="ghost" size="md" onlyIcon className="md:hidden" aria-label="Leftmenu toggle">
                            <MenuIcon />
                        </Button>
                    </Drawer.Trigger>
                    <Drawer.Portal>
                ...
                <div className="hidden gap-2 md:inline-flex md:gap-6">
                    <Link
                        className={cn("text-default-700 hover:text-default-900 text-[15px] transition-all", {
                            "text-default-900 font-medium": pathname.includes("/docs/components"),
                        })}
            ...
            <div className="flex items-center">
                <Button variant={"ghost"} onlyIcon asChild aria-label="Github">
